    ...
    <div class="main-header">
        ...
        <div class="nav-bar">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a id='log-button' class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#login_modal">
            ...
            <div class="user-widget">
                <div class="user-links">
                    ...
                    <div class="btn-container">
                        <a class="btn btn-primary" id='logout-button' href="actions/logout.php">
                        ...
                        <a class="btn btn-primary" id="settings" href="settings.php">
